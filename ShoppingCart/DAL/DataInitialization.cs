...
namespace ShoppingCart.DAL
{
    public class DataInitialization: DropCreateDatabaseIfModelChanges<ShoppingCartContext>
    {
        ...
        {
            // Create four categories, one author, and four books.
            // The four books are all related to the first category, as well as the only author created.
            // The objects are added to the corresponding EF dataset before calling to save the objects to the database
